...
#     # 2, 128, 400, 352  2,256,200,176
#     x1 = torch.rand(2, 128, 400, 352)
#     x2 = torch.rand(2, 256, 200, 176)
#     x3 = torch.rand(2, 512, 100, 88)

#     x4 = torch.rand(2, 768, 200, 176)

#     model1 = FreqFusion(hr_channels=256, lr_channels=512)
#     model2 = FreqFusion(hr_channels=128, lr_channels=768)

#     # [2,25,200,176],[2,256,200,176],[2,512,200,176]
#     mask_lr1, hr_feat2, lr_feat3 = model1(hr_feat=x2, lr_feat=x3)
#     mask_lr2, hr_feat1, lr_feat23 = model2(x1, torch.cat([hr_feat2,lr_feat3],dim=1))

#     # mask_lr2, hr_feat1, lr_feat23 = model2(hr_feat=x1, lr_feat=x4)
#     x123 = torch.cat([hr_feat1, lr_feat23], dim=1)
